        ...
        >
          ...
          {isEmpty ? (
            <div
              className={
                isMemberSession
                  ? 'flex flex-1 flex-col items-center justify-center p-8 pb-32'
                  : 'flex shrink-0 flex-col items-center px-8 pb-10 pt-[11vh]'
              }
            >
              <div className={`flex flex-col items-center text-center ${isMemberSession ? 'max-w-md' : 'max-w-3xl'}`}>
                {isMemberSession ? (
                  <>
                    <span className="material-symbols-outlined mb-4 text-[48px] text-[var(--color-text-tertiary)]">smart_toy</span>
                  ...
                  <h1
                    className="text-[24px] font-normal leading-tight tracking-normal text-[var(--color-text-primary)]"
            ...
            <>
              {!isMemberSession && !isMobileLayout && session?.workDirExists === false && (
                <div className="border-b border-[var(--color-border)]/70 px-4 py-2">
                  <div className="mx-auto inline-flex max-w-full items-center gap-2 rounded-lg border border-[var(--color-error)]/20 bg-[var(--color-error)]/8 px-3 py-1.5 text-[11px] text-[var(--color-error)]">
