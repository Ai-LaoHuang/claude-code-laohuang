export const en = {
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes claude-code-laohuang; replace documented claude <args> with claude-code-laohuang <args>, for example: claude-code-laohuang plugin install ... or claude-code-laohuang mcp add ...',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code LaoHuang notifications are enabled',
