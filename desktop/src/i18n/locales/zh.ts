...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '直接运行宿主机命令，用于安装插件、Skills、MCP 等扩展。桌面端已内置 claude-code-laohuang；文档里的 claude <参数> 可替换成 claude-code-laohuang <参数>，例如 claude-code-laohuang plugin install ... 或 claude-code-laohuang mcp add ...',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code LaoHuang 通知已启用',
