...
const BASE_PROSE_CLASSES = `markdown-prose prose prose-sm min-w-0 max-w-none break-words [overflow-wrap:anywhere] text-[13px] font-normal text-[var(--color-text-primary)]
  prose-headings:text-[var(--color-text-primary)] prose-headings:font-normal
  prose-p:my-2 prose-p:text-[13px] prose-p:font-normal prose-p:leading-[1.65]
  prose-p:break-words prose-p:[overflow-wrap:anywhere]
  prose-code:text-[12px] prose-code:text-[var(--color-code-fg)] prose-code:font-[var(--font-mono)] prose-code:font-normal prose-code:bg-[var(--color-code-bg)] prose-code:border prose-code:border-[var(--color-border)] prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-md prose-code:before:hidden prose-code:after:hidden
  ...
  prose-strong:font-normal prose-strong:text-[var(--color-text-primary)]
  prose-ul:my-2 prose-ol:my-2
  prose-li:my-0.5
  prose-table:my-0 prose-table:w-full prose-table:table-auto prose-table:text-[12px]
...
const DOCUMENT_PROSE_CLASSES = `
  ...
  prose-h1:mb-4 prose-h1:text-[19px] prose-h1:font-normal prose-h1:leading-tight
  prose-h2:mt-7 prose-h2:mb-3 prose-h2:border-b prose-h2:border-[var(--color-border)] prose-h2:pb-2 prose-h2:text-[16px] prose-h2:font-normal
  prose-h3:mt-5 prose-h3:mb-2 prose-h3:text-[14px] prose-h3:font-normal
  prose-h4:mt-4 prose-h4:mb-2 prose-h4:text-[13px] prose-h4:font-normal
