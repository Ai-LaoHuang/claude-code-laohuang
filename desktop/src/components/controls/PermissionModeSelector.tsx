...
export function PermissionModeSelector({ workDir: workDirProp, compact = false, variant = 'default', value, onChange }: Props = {}) {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        title={compact ? displayLabels[currentMode] : undefined}
        className={isCodexComposer
          ? 'codex-composer-permission-button'
      ...
      >
        ...
        {(!compact || isCodexComposer) && (
          <>
            <span>{displayLabels[currentMode]}</span>
