    ...
    <div ref={ref} className="relative min-w-0 shrink-0">
      ...
      >
        <div className="flex min-w-0 flex-1 items-center gap-2">
          <span className={`${compact && !isCodexComposer ? 'text-xs' : 'text-sm'} min-w-0 flex-1 truncate font-semibold text-[var(--color-text-primary)]`}>
            {buttonModelLabel}
          </span>
          {(!compact || isCodexComposer) && buttonProviderLabel && (
