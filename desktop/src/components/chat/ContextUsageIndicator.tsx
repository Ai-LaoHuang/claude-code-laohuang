    ...
    <div className="group/context relative pointer-events-auto">
      <button
        ...
        className={isCodexComposer
          ? 'codex-composer-context-button h-8 shrink-0'
      ...
      <div className={`opaque-popover pointer-events-none absolute bottom-full right-0 z-40 mb-2 w-[320px] max-w-[calc(100vw-2rem)] translate-y-1 rounded-[var(--radius-lg)] border border-[var(--color-border)] p-4 text-left opacity-0 shadow-[var(--shadow-dropdown)] transition-all duration-150 group-hover/context:translate-y-0 group-hover/context:opacity-100 group-focus-within/context:translate-y-0 group-focus-within/context:opacity-100 ${
        compact ? 'hidden' : ''
      }`}>
