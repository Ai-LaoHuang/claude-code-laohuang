  ...
  return (
    <div className="group mb-5 flex justify-end">
      ...
      >
        ...
        {hasText && (
          <div
            className="min-w-0 max-w-full bg-[var(--color-surface-user-msg)] px-4 py-3 text-[13px] font-normal leading-[1.65] text-[var(--color-text-primary)] whitespace-pre-wrap break-words"
            style={{
