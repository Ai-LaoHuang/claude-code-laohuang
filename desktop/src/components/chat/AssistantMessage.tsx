...
export function AssistantMessage({ content, isStreaming }: Props) {
  ...
  return (
    <div className="group mb-5 flex justify-start">
      ...
      >
        <div className={`rounded-[18px] rounded-tl-[8px] border border-[var(--color-border)]/60 bg-[var(--color-surface)] px-4 py-3 text-[13px] font-normal text-[var(--color-text-primary)] shadow-sm ${
