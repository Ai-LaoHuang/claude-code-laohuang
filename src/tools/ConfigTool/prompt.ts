...
export const DESCRIPTION = 'Get or set Claude-code-laohuang configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Claude-code-laohuang configuration settings.

  View or change Claude-code-laohuang settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
