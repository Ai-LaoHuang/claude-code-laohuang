...
export type GlobalConfig = {
  ...
  minSleepDurationMs?: number // proactive mode minimum sleep duration override
  maxSleepDurationMs?: number // proactive mode maximum sleep duration override
  ...
  firstStartTime?: string // ISO timestamp when Claude-code-laohuang was first started on this machine
  ...
  // Claude-code-laohuang usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Claude-code-laohuang OAuth token
  ...
  // Claude-code-laohuang hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
