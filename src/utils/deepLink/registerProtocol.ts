...
const APP_NAME = 'Claude-code-laohuang URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Claude-code-laohuang URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Claude-code-laohuang Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Claude-code-laohuang
