...
/**
 * Resolve Claude-code-laohuang-specific path patterns for sandbox-runtime.
 *
 * Claude-code-laohuang uses special path prefixes in permission rules:
...
/**
 * Convert Claude-code-laohuang settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Claude-code-laohuang started)
