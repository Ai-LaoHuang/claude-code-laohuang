...
/**
 * Fetch the user's first Claude-code-laohuang token date and store in config.
 * This is called after successful login to cache when they started using Claude-code-laohuang.
 */
