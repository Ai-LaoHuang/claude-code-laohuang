...
/**
 * Get Claude-code-laohuang MCP configurations (excludes claude.ai servers from the
 ...
 * @returns Claude-code-laohuang server configurations with appropriate scopes
 */
