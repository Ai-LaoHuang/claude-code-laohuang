...
Hooks run commands at specific points in Claude-code-laohuang's lifecycle.
...
Modify Claude-code-laohuang configuration by updating settings.json files.
