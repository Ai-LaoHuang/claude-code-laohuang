...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for Claude-code-laohuang.\n' +
  '\n' +
  'Claude-code-laohuang has an "auto mode" that uses an AI classifier to decide whether ' +
