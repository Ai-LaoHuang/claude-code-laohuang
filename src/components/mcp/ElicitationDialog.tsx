...
function ElicitationFormDialog({
  ...
  useNotifyAfterTimeout('Claude-code-laohuang needs your input', 'elicitation_dialog');
...
function ElicitationURLDialog({
  ...
  useNotifyAfterTimeout('Claude-code-laohuang needs your input', 'elicitation_url_dialog');
