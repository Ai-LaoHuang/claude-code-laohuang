...
export default class App extends (PureComponent as any)<Props, State> {
...
componentDidCatch(error: Error) {
  ...
  handleSuspend = (): void => {
    ...
    // Emit suspend event for Claude-code-laohuang to handle. Mostly just has a notification
    ...
    const resumeHandler = () => {
      ...
      // Emit resume event for Claude-code-laohuang to handle
