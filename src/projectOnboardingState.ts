...
export function getSteps(): Step[] {
  ...
  return [
    {
      key: 'workspace',
      text: 'Ask Claude-code-laohuang to create a new app or clone a repository',
      isComplete: false,
      isCompletable: true,
    ...
    {
      key: 'claudemd',
      text: 'Run /init to create a CLAUDE.md file with instructions for Claude-code-laohuang',
