...
function ResumeCommand({
  ...
  async function handleSelect(log: LogOption) {
    ...
    if (crossProjectCheck.isCrossProject) {
      ...
      const resumeCommand = (crossProjectCheck as {
        isCrossProject: true
...
export const call: LocalJSXCommandCall = async (onDone, context, args) => {
  ...
  if (!arg) {
    const ResumeCommandWithKey = ResumeCommand as React.ComponentType<{
      key?: React.Key
      onDone: typeof onDone
      onResume: typeof onResume
    }>
    return <ResumeCommandWithKey key={Date.now()} onDone={onDone} onResume={onResume} />;
  }
