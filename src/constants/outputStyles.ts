...
export const OUTPUT_STYLE_CONFIG: OutputStyles = {
  ...
  Explanatory: {
    ...
    source: 'built-in',
    description:
      'Claude-code-laohuang explains its implementation choices and codebase patterns',
...
${EXPLANATORY_FEATURE_PROMPT}`,
  ...
  Learning: {
    ...
    source: 'built-in',
    description:
      'Claude-code-laohuang pauses and asks you to write small pieces of code for hands-on practice',
    keepCodingInstructions: true,
