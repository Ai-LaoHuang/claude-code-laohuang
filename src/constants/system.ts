...
const DEFAULT_PREFIX = `You are Claude-code-laohuang, a local CLI built by laohuang.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Claude-code-laohuang, a local CLI built by laohuang, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are Claude-code-laohuang, a local agent built by laohuang on the Claude Agent SDK.`
